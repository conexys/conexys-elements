...
export const useTableData = (fpHash, getServerURL, postServerURL, deleteServerURL, restoreServerURL, t) => {
    ...
    return {
        ...
        handleFormSubmit, handleFormDelete, handleFormDeleteMulti, handleFormRestoreMulti, handleInputChange, handleFormRestore, formInputs,
