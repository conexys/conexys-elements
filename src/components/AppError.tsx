...
import type { AppErrorProps } from '../types/components/pages.types';

/**
 * React component for displaying an error message.
 * @param {AppErrorProps} props - Component props.
 * @param {ErrorObject} props.error - Error object containing information about the error.
  ...
  return (
    <div className="container">
      ...
      <div className="instructions">
        ...
        <h4>{error.message || 'An unexpected error occurred'}</h4>
        <p>{t('error.you_can')}</p>
        <div className="step">
          <svg
            className="icon"
