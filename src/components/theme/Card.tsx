...
import type { CardProps } from '../../types/components/theme.types';
...
const Card: React.FC<CardProps> = ({
  ...
  // When inParagraph is true, use span instead of div
  ...
  return (
    <ContentContainer className="card">
      <InnerContainer className="card-body">
        ...
        <InnerContainer className="card-content">{children}</InnerContainer>
      </InnerContainer>
    </ContentContainer>
  );
};
